    ...
    <div className="min-h-screen bg-black text-white font-sans antialiased relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-8 md:py-16 max-w-4xl relative z-10">
        <header className="text-center mb-8 md:mb-12">
          ...
          {teamLeaderName}, Thank You for Registering!
          </h1>
        ...
        <div className="bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg border border-white border-opacity-20 rounded-xl p-4 md:p-6 mb-8 md:mb-12">
          <p className="text-center text-base md:text-lg text-gray-200">
            A confirmation email has been sent to your registered email address. Please check your inbox (and spam folder, just in case) for more details.
          </p>
        </div>
          ...
          {[
            {
              ...
              content: "The hackathon starts on [Start Date] at [Start Time]. Make sure to arrive early for check-in and the opening ceremony.",
            },
            {
              icon: Users,
              title: "Form Your Team",
              content: "If you haven't already, start forming your team. You can have up to [Team Size] members. Don't worry if you're going solo - we'll have a team formation session!",
            },
            {
              icon: Lightbulb,
              title: "Brainstorm Ideas",
              content: "Start thinking about potential projects. We'll announce the hackathon theme during the opening ceremony, but it's never too early to brainstorm!",
            },
            {
              icon: Bell,
              title: "Stay Tuned",
